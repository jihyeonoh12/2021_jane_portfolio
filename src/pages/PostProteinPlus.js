    ...
    render() {
        return (
            ...
            <div className="post_container">
                ...
                <PostContentList class="flex-row-reverse" image={targetA} title="Target Audience" 
                ...
                <PostContent class="flex-row-reverse" image={content1} title="Design solution :" 
                body="
                ...
                <PostOutcome image={content1} title="Final Design System" body="Fresh n Lean is a meal delivery service that provides chef prepared, organic" button="This is Button" class="hidden"/>
                <PostFooter />
                </div>
            </div>
        )
