    ...
    render() {
        return (
            ...
            <div className="post_container">
                ...
                />
                <PostContent class="" image={content1} title="Menu and Meal Plan Page" body="Fresh n’ Lean provides performance meal plan that specifically targets fitness enthusiast and professional athlets who want nutrient dense and high-protein meal that fits their diet." h3="" p=""/>
                ...
                <PostContent class="" image={content3} title="UX Problem" body="Through research, we found out that there is huge drop off rate as the user enters the order funnel.
Our hypothesis was that current user flow into the order page is too abrupt for users." h3="" p=""/>

                <PostContent class="row-reverse" image={content4} title="UX solution" 
                body="
                As a solution, we want to revamp the menu page and build a separate page that educate our user on the meal plans and help them find what’s right plans before have them jump into the order funnel."
                 h3="" p=""/>
                 <PostContent class="" image={content5} title="UI solution" 
